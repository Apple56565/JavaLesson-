...
//      첫번쨰 명령문 - 출력문
        ...
        System.out.println("Marathon : " + 42.195);    // 문자열과 정수형

        // 제어 문자(Control Character)와 출력
        System.out.print("Hello\n");    // \n : 줄바꿈
        System.out.print("Java");
        System.out.print("Hello\t");    // \t : tab 문자(기능)
        System.out.print("Ja\\va\n");

        // 형식 문자(Format Character)
        System.out.printf("철수의 나이는 %-5d살 입니다.\n", 15);    // %d : 정수 표현
        System.out.printf("철수의 키는 %7.2fcm 입니다.\n", 161.5);  // %f : 실수 표현
        System.out.printf("철수의 키는 %5.1fcm 이고, 몸무개는 %5.1fkg 입니다.\n", 161.5635, 60.7); // 개수와 위치가 맞아야 합니다
        ...
        a1 = 100;
        byte b1 = 100;  // 1바이트 ---> 선언과 사용을 동시에 : 초기화
        byte c1 = 100;
//        byte d1 = a1 + b1 +c1;    : 이렇게 하면 에러가 발생함
        a1 = -128;
